# -*- coding: utf-8 -*-
#
# Skogestad Python documentation build configuration file, created by
...
# Mock the utilities used by the code
...
htmlhelp_basename = 'SkogestadPythondoc'
...
latex_documents = [
  ('index', 'SkogestadPython.tex', u'Skogestad Python Documentation',
   u'University of Pretoria CBT students', 'manual'),
]
...
man_pages = [
    ('index', 'skogestadpython', u'Skogestad Python Documentation',
     [u'University of Pretoria CBT students'], 1)
]
